-- AlterEnum
ALTER TYPE "CredentialType" ADD VALUE 'Jwt';

-- AlterTable
ALTER TABLE "Announcement"
    ALTER COLUMN "id" SET DEFAULT nanoid('ann:');
...
-- AlterTable
ALTER TABLE "BarWeek"
    ALTER COLUMN "id" SET DEFAULT nanoid('barweek:');
...
-- AlterTable
ALTER TABLE "ContributionOption"
...
-- AlterTable
ALTER TABLE "GodparentRequest"
    ALTER COLUMN "id" SET DEFAULT nanoid('godparentreq:');
...
-- AlterTable
ALTER TABLE "LydiaAccount"
    ALTER COLUMN "id" SET DEFAULT nanoid('lydia:');

-- AlterTable
ALTER TABLE "LydiaTransaction"
...
-- AlterTable
ALTER TABLE "StudentAssociation"
...
ALTER TABLE "TeachingUnit"
    ALTER COLUMN "id" SET DEFAULT nanoid('ue:');
